...
- We got a couple of hours to get hands-on experience with [DIGITS](https://developer.nvidia.com/digits) for image classification in NVIDIA lab. Here are some notes :
    ...
    <img src="https://dplogscontent.blob.core.windows.net/dplogs/networks2models.png" width="100%" height="100%" />
    ...
    - inferencing after models are created (image from NVIDIA)
     <img src="https://dplogscontent.blob.core.windows.net/dplogs/networks2modelsandinference.png" width="100%" height="100%" />
     - Screenshot of inferencing written digits after creating a model by training the network with digit images. Accuracy 96.33%.
     <img src="https://dplogscontent.blob.core.windows.net/dplogs/inferencingmodel1.png" width="100%" height="100%" />
     - Screenshot of inferencing random objects after creating a model by training the network with Caltech 101. Accuracy 96.33%.
     <img src="https://dplogscontent.blob.core.windows.net/dplogs/inferencingmodel2.png" width="100%" height="100%" />
- Other highlights : 
